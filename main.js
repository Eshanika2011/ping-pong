rightWristY = 0; rightWristX = 0; score_right_wrist = 0; game_status = "";
...
function startGame() { game_status = "start"; document.getElementById("status").innerHTML = "Game Is Loaded"; }
